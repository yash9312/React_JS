            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-8 lg:py-10">
                    ...
                    <div className="mb-6 md:mb-0">
                        <Link to="/" className="flex items-center">
                            <img
                                ...
                                className="mr-3 h-16 w-auto transition-transform duration-300 hover:scale-105"
                                alt="Logo"
                            />
                        </Link>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="font-medium">
                                <li className="mb-4">
                                    <Link to="/" className="hover:underline hover:text-yellow-400 transition duration-300">
                                        Home
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/about" className="hover:underline hover:text-yellow-400 transition duration-300">
                                        About
                                    </Link>
                                </li>
                            </ul>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-400 sm:text-center">
                        © 2025 Yash Sorathiya. All Rights Reserved.
                    </span>
